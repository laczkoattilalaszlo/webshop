...
export async function addEventListenerToSearchInput() {
...
export async function addEventListenerToSearchAllProductsRadioButton() {
    const searchInput = document.querySelector("#search-range-all-products");
